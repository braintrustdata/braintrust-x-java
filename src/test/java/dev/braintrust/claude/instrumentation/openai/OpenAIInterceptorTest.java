...
class OpenAIInterceptorTest {
    ...
    void testTraceCompletionSuccess() {
        ...
        var result =
                OpenAIInterceptor.traceCompletion(
                        ...
                        request,
                        req ->
                                new OpenAIInterceptor.RequestDetails(
                                        req.model, req.maxTokens, req.temperature),
                        resp ->
                                new OpenAIInterceptor.ResponseDetails(
        ...
        assertThat(
                        attributes.get(
                                io.opentelemetry.api.common.AttributeKey.stringKey("openai.model")))
                .isEqualTo("gpt-4");
        assertThat(
                        attributes.get(
    ...
    void testTraceStreamingCompletion() {
        ...
        assertThat(span.getAttributes().get(BraintrustSpanProcessor.USAGE_COMPLETION_TOKENS))
                .isEqualTo(100L);
        assertThat(span.getAttributes().get(BraintrustSpanProcessor.USAGE_TOTAL_TOKENS))
                .isEqualTo(300L);
    }
