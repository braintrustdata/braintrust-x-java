package dev.braintrust.claude.config;
...
class BraintrustConfigTest {
    ...
    void testBuilderOverridesEnvironment() {
        ...
        // When
        var config = BraintrustConfig.builder().apiKey("override-key").debug(false).build();
    ...
    void testApiUrlParsing(String url) {
        // When
        var config = BraintrustConfig.builder().apiKey("test").apiUrl(url).build();
