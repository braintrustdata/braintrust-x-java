 ...
 * Uses builder pattern with sensible defaults and environment variable support.
 */
public final class BraintrustConfig {
    ...
    public static final class Builder {
        ...
        private Builder() {
            ...
            this.enableTraceConsoleLog = Boolean.parseBoolean(
                getEnv("BRAINTRUST_ENABLE_TRACE_CONSOLE_LOG", "false")
            );
        ...
        public BraintrustConfig build() {
            if (apiKey == null || apiKey.isBlank()) {
                throw new IllegalStateException(
                    "API key is required. Set BRAINTRUST_API_KEY environment variable or use apiKey() method."
                );
            }
