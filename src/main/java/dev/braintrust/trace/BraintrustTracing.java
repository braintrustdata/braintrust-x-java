 ...
 * Provides convenient methods to initialize OpenTelemetry with Braintrust configuration.
 */
public final class BraintrustTracing {
    ...
    /**
     * Quick start method that sets up OpenTelemetry with Braintrust defaults.
    ...
    public static final class SpanUtils {
        ...
        public static void addUsageMetrics(long promptTokens, long completionTokens, double cost) {
            ...
            span.setAttribute(BraintrustSpanProcessor.USAGE_TOTAL_TOKENS, promptTokens + completionTokens);
