...
public class BraintrustApiClient implements AutoCloseable {
    ...
    public CompletableFuture<List<Project>> listProjects() {
        return getAsync("/projects", ProjectList.class).thenApply(ProjectList::projects);
    }
    ...
    public record Project(String id, String name, String createdAt, String updatedAt) {}
