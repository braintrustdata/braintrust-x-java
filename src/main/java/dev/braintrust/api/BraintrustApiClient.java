...
/**
 * Modern API client for Braintrust using Java 11+ HTTP client.
...
public class BraintrustApiClient implements AutoCloseable {
    ...
    public CompletableFuture<Project> createProject(String name) {
        ...
        return postAsync("/projects", request, Project.class);
    }
    ...
    public CompletableFuture<Optional<Project>> getProject(String projectId) {
        return getAsync("/projects/" + projectId, Project.class)
    ...
    public CompletableFuture<List<Project>> listProjects() {
        return getAsync("/projects", ProjectList.class)
            .thenApply(ProjectList::projects);
    }
    ...
    public CompletableFuture<Experiment> createExperiment(CreateExperimentRequest request) {
        return postAsync("/experiments", request, Experiment.class);
    }
    ...
    public CompletableFuture<Optional<Experiment>> getExperiment(String experimentId) {
        return getAsync("/experiments/" + experimentId, Experiment.class)
    ...
    public CompletableFuture<Dataset> createDataset(CreateDatasetRequest request) {
        return postAsync("/datasets", request, Dataset.class);
    }
    
    /**
     * Inserts events into a dataset.
     */
    public CompletableFuture<InsertEventsResponse> insertDatasetEvents(String datasetId, List<DatasetEvent> events) {
        var request = new InsertEventsRequest(events);
        return postAsync("/datasets/" + datasetId + "/insert", request, InsertEventsResponse.class);
    }
    ...
    public CompletableFuture<List<Dataset>> listDatasets(String projectId) {
        return getAsync("/datasets?project_id=" + projectId, DatasetList.class)
